...
class PaxWalletRepository {
  ...
  Future<bool> walletExistsForParticipant(String participantId) async {
    try {
      ...
      if (kDebugMode) {
        print('Error checking if wallet exists: $e');
      }
      rethrow;
    }
  }
  ...
  Future<PaxWallet?> createWallet({
    ...
    try {
      ...
      if (exists) {
        if (kDebugMode) {
          print('Wallet already exists for participant $participantId');
        }
  ...
  Future<PaxWallet> updateSmartAccountAddress({
    ...
    try {
      ...
      if (kDebugMode) {
        print('Error updating smart account address: $e');
      }
      rethrow;
    }
  }
  ...
  Future<PaxWallet> updateWalletWithLogData({
    ...
    try {
      ...
      if (kDebugMode) {
        print('Error updating wallet with log data: $e');
      }
      rethrow;
    }
  }
