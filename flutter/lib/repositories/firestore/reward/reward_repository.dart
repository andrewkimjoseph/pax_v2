...
class RewardRepository {
  ...
  Future<List<Reward>> getRewardsForParticipant(String participantId) async {
    try {
      ...
      if (kDebugMode) {
        debugPrint('[Error] Error getting rewards: $e');
      }
  ...
  Future<Reward?> getReward(String id) async {
    try {
      ...
      if (kDebugMode) {
        debugPrint('[Error] Error getting reward: $e');
      }
      rethrow;
    }
  }
  ...
  Future<List<Reward>> getRewardsForTask(String taskId) async {
    try {
      ...
      if (kDebugMode) {
        debugPrint('[Error] Error getting rewards for task: $e');
      }
      // Return empty list on error
      return [];
    }
  ...
  Future<List<Reward>> getRewardsForTaskCompletion(
    ...
    try {
      ...
      if (kDebugMode) {
        debugPrint('[Error] Error getting rewards for task completion: $e');
      }
      // Return empty list on error
      return [];
    }
  ...
  Stream<List<Reward>> streamRewardsForParticipant(String? participantId) {
    ...
    try {
      ...
      if (kDebugMode) {
        debugPrint('[Error] Error streaming rewards: $e');
      }
